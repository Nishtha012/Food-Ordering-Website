<html>
<head>
    <title> Guest Signup | BV EATS </title>
  </head>
   ...
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <label style="margin-left: 5px;">Already registered?</label> <br>
       <label style="margin-left: 5px;"><a href="customerlogin.php">then login</a></label>
