...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit">BV EATS </span>?</strong>
     <br>
    Fill the form and let us know your Feedback.
    </div>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <input type="submit" name="submit" type="button" id="submit" name="submit" class="btn btn-primary pull-right" onclick="show()" />    
        </form>
